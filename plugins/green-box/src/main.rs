...
//! Not a reference plugin; M7 will produce polished reference
//! plugins (clock, wallpaper, shader-bg).
//!
//! Sister plugins: `red-box` (~78% opaque), `blue-box` (50% opaque).
...
// Green at 100% opacity — fully hides lower-z plugins in its region.
const COLOR_R: f32 = 0.0;
const COLOR_G: f32 = 1.0;
const COLOR_B: f32 = 0.0;
const COLOR_A: f32 = 1.0;
