...
# llvmpipe, compositing the plugins' virgl-rendered dmabufs as black.
# (Observed: sway's output was bochs's card0-Virtual-1, and `eglinfo` reported
# virgl on the GBM platform but llvmpipe on the Wayland platform.) But the
