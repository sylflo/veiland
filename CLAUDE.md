...
12. **M11 — Reference plugins:** clock (first cosmic-text consumer), simple wallpaper, shader background. The original "M10 — reference plugins" entry, pushed back one slot because the clock needs the text crate from M10.
